    ...
    <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
            ...
            <div class="container">
                <div class="row">
                    <div class="display-header d-flex justify-content-between pb-3">
                        <h2 class="display-7 text-dark text-uppercase">Best Seller</h2>
                        <div class="btn-right">
        ...
        <section id="last-items" class="product-store padding-large position-relative">
            <div class="container">
                <div class="row">
                    <div class="display-header d-flex justify-content-between pb-3">
                        <h2 class="display-7 text-dark text-uppercase">Last Items</h2>
                        <div class="btn-right">
                            <a href="pshow?uid=${user.userName}&index=1" class="btn btn-medium btn-normal text-uppercase">Go to Shop</a>
                        </div>
                    </div>
        ...
        <section id="good-rate" class="product-store padding-large position-relative">
            <div class="container">
                <div class="row">
                    <div class="display-header d-flex justify-content-between pb-3">
                        <h2 class="display-7 text-dark text-uppercase">Good Items</h2>
                        <div class="btn-right">
                            <a href="pshow?uid=${user.userName}&index=1" class="btn btn-medium btn-normal text-uppercase">Go to Shop</a>
                        </div>
                    </div>
